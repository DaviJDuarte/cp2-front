...
export default function Ex8() {
  ...
  return (
    ...
    <section className="flex justify-center items-center mb-12">
      <div className="bg-white p-6 rounded-lg shadow-md w-64 text-center transition hover:translate-y-[-8px] hover:shadow-xl shadow-gray-600">
        <div className="text-4xl text-blue-600 mb-4 flex justify-center">
          <FaShoppingCart className="animate-(--animate-bounce)"/>
        </div>
